...
\headerbox{Questions We Explore }{name=questions,column=3,row=0,bottomaligned=objectives}{
	How do magnetic fields affect atomic nuclei, specifically hte hydrogen atom? How can we model the affects of a magnetic field on the hydrogen atom? What happens to our models and predictions if we allow for a varying magnetic field, specifically one increasing linearly in time?
}
