...
\begin{Deletion}
There is a mistake in this part, the calculations I did later allowed me to find and correct this when the results differed.
\begin{align}
...
\section{Land\'{e} g Analysis}
Consider the Lande \'{e} g factor derived previously with a spin value of $s=\frac{1}{2}$,
\begin{align}
